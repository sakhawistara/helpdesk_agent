...
Public Class utama
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.ServerClick
        ...
        If cmb_status.Value = "Closed" Then
            ...
            If chk_posting.Checked = True Then
                Reply_Posting(cmb_source_type.Value, TicketNo, ReplaceSpecialLetter(html_solution.Html), ParamCustomer)
            Else
    ...
    Sub layer1()
        ...
        Try
            ...
            If dr.HasRows Then
                ...
                If dr("Posting").ToString = "YES" Then
                    chk_posting.Checked = True
                Else
                    chk_posting.Checked = False
                End If
    ...
    Private Sub Btn_Update_Click(sender As Object, e As EventArgs) Handles Btn_Update.ServerClick
        ...
        If dr.Read() Then
            ...
            Else
                ...
                If cmb_status.Value = "Closed" Or cmb_status.Value = "On Progress" Then
                    If cmb_status.Value = "Closed" Then
                    ...
                    ElseIf cmb_status.Value = "On Progress" Then
                        subjectTicket = "On Progress"
                    End If
    ...
    Private Sub Btn_Assign_Click(sender As Object, e As EventArgs) Handles Btn_Assign.ServerClick
        ...
        comm.Parameters.Add("@AgentCreate", Data.SqlDbType.VarChar).Value = Session("UserName")
        If Session("LoginType") = "layer2" Then
            comm.Parameters.Add("@TicketPosition", Data.SqlDbType.VarChar).Value = 1
        Else
    ...
    Sub button_download()
        Response.Redirect(Path_Ticket.Value)
    End Sub
    ...
    Sub interaction()
        Dim strInteraction As String = "Select *,  mkaryawan.Name from tInteraction inner join mkaryawan on tInteraction.AgentCreate = mkaryawan.NIK where tInteraction.TicketNumber='" & lbl_ticket_number.Text & "'order by DateCreate desc"
        Try
    ...
    Function Reply_Posting(ByVal Type As String, ByVal TicketNumber As String, ByVal Message As String, ByVal Account As String)
        ...
        ElseIf Type = "Sms" Then
            insertTable("ICC_SMSOutput", "MESSAGEID,MESSAGE,PHONEDESTINATION,PHONESENDER", "" & Request.QueryString("id") & "," & ReplaceSpecialLetter(html_solution.Html) & "," & lbl_phone.Text & "," & PhoneSender & "")
