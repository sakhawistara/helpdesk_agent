<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HTML/Ticket.Master" CodeBehind="twitter_keyword.aspx.vb" Inherits="ICC.twitter_keyword" %>
        ...
        <div class="panel-body">
            <div class="tab-content">
                ...
                <asp:DropDownList ID="DD1" CssClass="form-control" runat="server" DataSourceID="DsDropdown" DataTextField="Text_Keywords" DataValueField="id"></asp:DropDownList>
                  <asp:SqlDataSource ID="DsDropdown" runat="server" ConnectionString="<%$ ConnectionStrings:SosmedConnection %>" SelectCommand="select id, Text_Keywords from mKeyword where FlagSource='tw'"></asp:SqlDataSource>
