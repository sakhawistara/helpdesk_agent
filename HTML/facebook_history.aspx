<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HTML/Ticket.Master" CodeBehind="facebook_history.aspx.vb" Inherits="ICC.facebook_history" %>
                ...
                <div class="panel panel-default table-responsive">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-comment"></i>&nbsp; Inbox Facebook
                        </div>
        ...
        <div class="col-sm-9">
            <div class="tab-content">
                <div class="panel panel-default table-responsive">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-comment"></i>&nbsp; Interaction Facebook
                                ...
                                <ul class="chat">
                                    ...
                                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="img/fahri.jpg" alt="User Avatar">
                                        </span>
                                        <div class="chat-body clearfix">
                                            <div class="header">
