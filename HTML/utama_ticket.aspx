<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/HTML/Ticket.Master" CodeBehind="utama_ticket.aspx.vb" Inherits="ICC.utama_ticket" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="FeaturedContent" runat="server">
    ...
    <script>
        ...
        function TesProduk(frm, kode) {
            if (document.getElementById('MainContent_TxtName_I').value != '') {

                showProduk(frm, document.getElementById('MainContent_TxtName_I').value, 'cariproduk', 'cariproduk');
                toggleBox('cariproduk', 1);
            }
        ...
        var xmlHttp
        function showProduk(frm, kode, pdid, NamaDiv) {
            xmlHttp = GetXmlHttpObject()
            if (xmlHttp == null) {
                alert("Browser does not support HTTP Request")
                return
            }
            var url = "popupKaryawan.aspx"
            url = url + "?kode=" + kode;
            url = url + "&frm=" + frm;
            url = url + "&pdid=" + pdid;
            url = url + "&div=" + NamaDiv;
            url = url + "&sid=" + Math.random();
            xmlHttp.onreadystatechange = stateChangedProduk;
            xmlHttp.open("GET", url, true);
            xmlHttp.send(null);
        }

        function stateChangedProduk() {
            ...
            <div class="row">
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <address>
                                    <dx:aspxgridlookup id="gl_cari" runat="server" clientinstancename="lookup" keyfieldname="CustomerID" theme="MetropolisBlue"
                                        selectionmode="Single" textformatstring="{0}" datasourceid="sql_customer" width="100%"
                                        allowuserinput="true" cssclass="form-control chzn-select">
                                     <GridViewProperties>                               
                                            <Settings ShowFilterRow="True" UseFixedTableLayout="true" />
                                     </GridViewProperties>
                                    <Columns>                                     
                                    <%--<dx:GridViewCommandColumn ShowSelectCheckbox="True" />--%>
                                    <dx:GridViewDataColumn FieldName="CustomerID" width="100px" Settings-AutoFilterCondition="Contains"/>
                                    <dx:GridViewDataColumn FieldName="NamaPerusahaan" width="300px" Settings-AutoFilterCondition="Contains"/>
                                    <dx:GridViewDataColumn FieldName="Alamat" width="600px" Settings-AutoFilterCondition="Contains"/>
                                    <dx:GridViewDataColumn FieldName="Email" width="200px" Settings-AutoFilterCondition="Contains"/>
                                    </Columns>     
                                </dx:aspxgridlookup>
                                </address>
                                <hr />
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapsHistory" class="panel-collapse collapse">
                            <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-11">
                    ...
                    <div id="div_button_ticket" runat="server" class="text-right">
                        ...
                        <a href="#ModalDispatchSatu" role="button" data-toggle="modal" class="btn btn-info" id="modal_dispatch_satu" runat="server">Dispatch</a>
                        <a href="#ModalDispatchDua" role="button" data-toggle="modal" class="btn btn-info" id="modal_dispatch_dua" runat="server">Dispatch</a>
                    </div>
